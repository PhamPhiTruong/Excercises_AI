...
public class Environment {
	...
	public EnvironmentState executeAction(Action action) {
		if(action.equals(SUCK_DIRT)) this.envState.setLocationState(envState.getAgentLocation(), LocationState.CLEAN);
		if(action.equals(MOVE_LEFT)) {
			this.envState.setAgentLocation(LOCATION_A);
			this.envState.setLocationState(LOCATION_A, envState.getLocationState(LOCATION_A));
		}
		if(action.equals(MOVE_RIGHT)) {
			this.envState.setAgentLocation(LOCATION_B);
			this.envState.setLocationState(LOCATION_B, envState.getLocationState(LOCATION_B));
		}
		return envState;
	}
